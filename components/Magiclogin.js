    ...
    <>
      <div className={styles.container}>
        ...
        <p className={styles.explain}>
          Connect users to your dApp using their email or social media accounts using{' '}
          <b>
            {' '}
            <a
        ...
        {address ? (
          <>
            <h2 style={{ fontSize: '1.3rem' }}>You&apos;re Connected! 👋</h2> <p>{address}</p>
          ...
          <>
            ...
            >
              ...
              <a className={styles.mainButton} onClick={() => connectWithMagic({ email })}>
                Login
              </a>
            </div>
          </>
